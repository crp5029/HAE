...
import com.hae.entities.menu.MenuItemEntity;

/**
 *
 * @author Chris Purtell
 */
public class MenuItemMapper implements Mapper  {

    
    public <E extends MenuItemEntity, D extends MenuItem> MenuItemMapper()
    {

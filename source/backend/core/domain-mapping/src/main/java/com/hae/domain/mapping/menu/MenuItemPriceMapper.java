...
import com.hae.entities.menu.MenuItemPriceEntity;

/**
 *
 * @author Chris Purtell
 */
public class MenuItemPriceMapper implements Mapper  {

    public <E extends MenuItemPriceEntity, D extends MenuItemPrice> MenuItemPriceMapper()
    {

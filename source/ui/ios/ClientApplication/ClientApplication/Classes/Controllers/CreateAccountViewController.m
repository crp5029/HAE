  ...
  //  for(int *y = 0; y < self.x; y++){
   ...
   // }
    ...
    if (cell == nil) {
        ...
        textLabel = [[UILabel alloc] initWithFrame:CGRectMake(5, 0, cell.frame.size.width-10, cell.frame.size.height / 2)];
        ...
        UILabel *aLabel = [labelArray objectAtIndex:indexPath.row];
